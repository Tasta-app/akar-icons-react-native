...
const VscodeFill = ({ color = 'currentColor', size = '24', ...otherProps }) => (
  ...
  >
    <g clipPath="url(#a)">
      ...
      <path d="M4.116 11.937.228 15.509s-.4.3 0 .837l1.805 1.66s.429.465 1.062-.065l4.121-3.158z" />
      <path d="m10.94 11.966 7.13-5.502-.047-5.505s-.305-1.202-1.32-.576L7.216 9.11z" />
