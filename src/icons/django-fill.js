...
const DjangoFill = ({ color = 'currentColor', size = '24', ...otherProps }) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <path d="M22 15.233V6.215h-4.17v7.675c0 3.387-.188 4.674-.785 5.786-.57 1.087-1.462 1.8-3.305 2.606L17.615 24c1.843-.862 2.735-1.643 3.412-2.88.726-1.288.973-2.782.973-5.887" />
    <path d="M21.585 0h-4.176v3.993h4.176z" />
  </svg>
);
